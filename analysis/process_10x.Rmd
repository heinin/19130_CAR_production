...
production_samples <- read_sheet(production_samples, sheet = "Samples original")
...
path_list <- list("run1" = unique(production_samples[which(production_samples$Run=="run1"),]$CellRanger_path1),
                  "run2" = unique(production_samples[which(production_samples$Run=="run2"),]$CellRanger_path1))
...
seurat_list <- prep_seurat_list_multiplexed(metadata = production_samples,
                                            batch_ID = "Run",
                                            cellRanger_path = "CellRanger_path1",
